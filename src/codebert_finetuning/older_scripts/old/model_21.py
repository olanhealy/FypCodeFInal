...
log_file = os.path.join(log_dir, "model_21_log.txt")
logging.basicConfig(
    level=logging.INFO,
    format="%(asctime)s - %(levelname)s - %(message)s",
    handlers=[logging.FileHandler(log_file), logging.StreamHandler()]
)
logging.info(" Starting Training with Optimisations...")
...
logging.info(" Starting Training with Optimised Parameters...")
trainer.train()
