# FILE: 23_train_final_cleaned.py
...
# Save Model
model.save_pretrained("../../FINAL_MODEL_24MAR/model_final")
tokenizer.save_pretrained("../../FINAL_MODEL_24MAR/model_final")
logger.info(" Final model saved to: ../../FINAL_MODEL_43MAR/model_final")
