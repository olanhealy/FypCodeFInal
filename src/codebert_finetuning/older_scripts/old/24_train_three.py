...
logger = logging.getLogger("larger_head_80_20")
logger.info("Training with frozen base + larger head (80/20 split)...")

# Load 80/20 Split Data
data_path = "../../Data/SSTUBS_ENHANCED_23MAR"
dataset = load_dataset("json", data_files={
    "train": f"{data_path}/train_80.json",
    "validation": f"{data_path}/val_20.json",
...
training_args = TrainingArguments(
    output_dir="../../FINAL_MODEL_LARGER_HEAD_8020",
    learning_rate=2e-5,
...
# Save
model.save_pretrained("../../FINAL_MODEL_LARGER_HEAD_8020/model_final")
tokenizer.save_pretrained("../../FINAL_MODEL_LARGER_HEAD_8020/model_final")
logger.info("Model saved to: ../../FINAL_MODEL_LARGER_HEAD_8020/model_final")
