...
log_file = os.path.join(log_dir, "model_20_log.txt")
logging.basicConfig(
    level=logging.INFO,
...
logging.info(" Starting Model 20 Training with Fixes...")
...
training_args = TrainingArguments(
    ...
    weight_decay=0.005,  # 🔥 Less aggressive decay
...
trainer = Trainer(
    ...
    tokenizer=tokenizer,
    callbacks=[EarlyStoppingCallback(early_stopping_patience=5)]  # 🔥 Patience increased
)

logging.info(" Starting Training with Fixes...")
trainer.train()
